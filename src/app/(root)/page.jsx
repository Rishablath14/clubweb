      ...
      <div className='w-[95%] md:w-[85%] shadow-lg my-2 xl:my-0 bg-white dark:bg-zinc-900 p-4 md:px-12 md:py-6 rounded-lg'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>
          <div className='border border-gray-200 dark:border-gray-600 p-4 rounded-lg text-center'>
            ...
            <p className='text-black font-semibold dark:text-white'>President 2024-25</p>
          </div>
          <div className='border border-gray-200 dark:border-gray-600 p-4 rounded-lg text-center'>
            <b className='text-lg'>Ankit Agrawal</b>
            <p className='text-black font-semibold dark:text-white'>Secretary 2024-25</p>
          </div>
        </div>
        <div className='flex flex-col justify-center items-center mt-4'>
          <p className='text-sm sm:text-base font-semibold mb-2 text-black dark:text-white animate-bounce'>Kindly fill in the Member's Data Form on Next page..</p>
